...
@property (nonatomic,strong) NSString *time;        ///< 请求时间      默认1446450360
@end

//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>首页
@interface HomeParam : BaseParam
@property (nonatomic,strong) NSString *limit;       ///< 每次请求获得结果个数 默认是4
